...
let circle = UIView(frame:CGRect(x: 25, y: 25, width: 50, height: 50))
...
UIView.animate(withDuration: 3, delay: 0, usingSpringWithDamping: 0.1, initialSpringVelocity: 6, options: UIViewAnimationOptions.curveEaseInOut, animations: {
        view.center.y += 100
...
let btn = PicButton(frame: CGRect(x: 0, y: 0, width: 200, height: 100))
